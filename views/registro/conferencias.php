    ...
    <div class="eventos-registro">
        <main class="eventos-registro__listado">
            ...
            <p class="eventos-registro__fecha--c">Viernes 5 de octubre</p>
            ...
            <p class="eventos-registro__fecha--c">Sábado 6 de octubre</p>
            <div class="eventos-registro__grid">
            ...
            <p class="eventos-registro__fecha--w">Viernes 5 de octubre</p>
            ...
            <p class="eventos-registro__fecha--w">Sábado 6 de octubre</p>
            <div class="eventos-registro__grid eventos--workshops">
