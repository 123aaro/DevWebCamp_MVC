<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">DevWebCamp es un conferencia para desarrolladores de todos los niveles y se lleva a cabo de forma presencial y en linea.</p>
        </div>

        <nav class="menu-redes"> 
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://www.facebook.com/aaron.dominguezrivero">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://github.com/123aaro">
